...
return [
    ...
    'is_need_extract_inheritance' => false,                 // Извлекать данные из родительских элементов? (для стратегии)

    // Настройки для стратегии \Chetkov\Extractor\Strategy\PropertiesExtractionStrategy
